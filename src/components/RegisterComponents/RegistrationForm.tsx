...
const RegistrationForm: React.FC<Props> = ({
  ...
  const handleCustomerFormSubmit = async (
    ...
    if (customerFormValues.password != customerFormValues.confirmPassword) {
      alert('Password and Confirm Password must be same');
      return;
    }
    setLoader(true);
    const cloneData = { ...customerFormValues };
    delete cloneData.confirmPassword;
    const token = await API.auth.signUpCustomer(cloneData);
          ...
          <div className='flex flex-wrap'>
            ...
            <div className='w-full mb-6'>
              <InputField
                ...
                isRequired
                fieldType='text'
                placeholderText='e.g abc@xyz.com'
            ...
            <div className='w-full mb-6'>
              <InputField
                ...
                fieldType='password'
                placeholderText=''
                value={customerFormValues.password}
                onChange={(e) =>
                  updateFormValues(
                    customerFormValues,
                    setCustomerFormValues,
            ...
            <div className='w-full mb-6'>
              <InputField
                ...
                fieldType='password'
                placeholderText=''
                value={customerFormValues.confirmPassword}
                onChange={(e) =>
                  updateFormValues(
                    customerFormValues,
                    setCustomerFormValues,
